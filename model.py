...
to_remove = ['created_date', 'publication_id', 'parent_id', 'article_id','id']
train_df = train_df[train_df.columns.difference(to_remove)]
# train_df.shape

# train_df["comment_text"] = train_df['comment_text'].str.replace('[^\w\s]','')
# test_df["comment_text"] = test_df['comment_text'].str.replace('[^\w\s]','')
